...
from scout.adapters.base import LanguageAdapter
from scout.adapters.plain_text import PlainTextAdapter
from scout.adapters.python import PythonAdapter

try:
    from scout.adapters.javascript import JavaScriptAdapter
